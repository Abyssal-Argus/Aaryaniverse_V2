...
export default function Work(){
    return(
        <>
        <div className="h-10 hidden"></div>
        <div id="work" className="text-center pb-20">
        ...
        <BackgroundGradient className="rounded-[22px] max-w-sm p-4 sm:p-10 bg-zinc-900 h-auto">
          ...
          At Alpas Technology, I interned as a Front-End Developer, where I enhanced my React skills through real-world projects and tasks. I also learned Next.js and improved my UI/UX design skills by focusing on clean, user-friendly interfaces. The experience helped me grow both technically and creatively.
          </p>
